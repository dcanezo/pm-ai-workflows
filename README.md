...
**Creation** takes prioritized items and generates execution-ready artifacts: PRDs, User Stories, UACs, UI Prompts, and Prototypes.
...
- `reference/` *(where applicable)* — supporting context, frameworks, or examples the skill draws from
